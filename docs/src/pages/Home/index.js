  ...
  component: (props) => {
    return (
      <div className={'react_echarts__home'}>
        <div
          className={'react_echarts__home_header'}
          style={{
        ...
        >
          <h1>React ECharts</h1>
          <span>
            A <strong>simple</strong> and <strong>declarative</strong> set of React components built on top of{' '}
        ...
        <div className={'react_echarts__home_description'}>
          ...
          <article>
            <h2>Customizable</h2>
            <span>A simple options-structure allows for deep customization.</span>
          </article>

          <article>
            <h2>Declarative</h2>
            <span>
              Purely presentational components. In most cases, charts look and behave exactly as you need without
              modifications.
            </span>
          </article>
        </div>
